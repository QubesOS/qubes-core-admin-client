...
class TC_00_RestoreInDispVM(qubesadmin.tests.QubesTestCase):
    ...
    def test_001_prepare_inner_args_exclude(self):
        ...
        argv = ["--exclude", "vm1", "--exclude", "vm2", "/backup/location"]
        args = qvm_backup_restore.parser.parse_args(argv)
        print(repr(args))
        obj = RestoreInDisposableVM(self.app, args)
        obj.storage_access_id = "abc"
    ...
    def test_002_prepare_inner_args_pass_file(self):
        ...
        argv = ["--passphrase-file=/tmp/some/file", "/backup/location"]
        args = qvm_backup_restore.parser.parse_args(argv)
        print(repr(args))
        obj = RestoreInDisposableVM(self.app, args)
        obj.storage_access_id = "abc"
    ...
    def test_010_clear_old_tags(self):
        ...
        for tag in (
            ...
            self.app.expected_calls[
                ("fedora-25", "admin.vm.tag.Remove", tag, None)
            ] = b"0\0"
            self.app.expected_calls[
                ("testvm", "admin.vm.tag.Remove", tag, None)
            ] = b"0\0"
    ...
    def test_020_create_dispvm(self, mock_check_call):
        ...
        self.app.expected_calls[
            (
                ...
                "mgmt-dvm",
                b"name=disp-backup-restore label=red",
            )
        ] = b"0\0"
        self.app.expected_calls[
            (
    ...
    def test_040_register_backup_source(self):
        ...
        args = unittest.mock.Mock(
            backup_location="/backup/path", appvm="backup-storage"
        )
        obj = RestoreInDisposableVM(self.app, args)
        obj.dispvm = unittest.mock.Mock(default_user="user2")
    ...
    def test_050_invalidate_backup_access(self):
        ...
        self.assertEqual(
            obj.storage_access_proc.mock_calls,
            [
                call.stdin.close(),
                call.wait(),
            ],
    ...
    def test_060_finalize_tags(self, mock_date):
        ...
        self.app.expected_calls[
            ("dom0", "admin.vm.tag.Get", "backup-restore-in-progress", None)
        ] = b"0\x000"
        self.app.expected_calls[
            (
                "fedora-25",
        ...
        args = unittest.mock.Mock(backup_location="/backup/path", appvm=None)
        obj = RestoreInDisposableVM(self.app, args)
        obj.finalize_tags()
        self.assertAllCalled()
    ...
    def test_100_run(self):
        ...
        args = unittest.mock.Mock(
            backup_location="/backup/path", pass_file=None, appvm=None
        )
        obj = RestoreInDisposableVM(self.app, args)
        methods = [
            "create_dispvm",
        ...
        with tempfile.NamedTemporaryFile() as tmp:
            with unittest.mock.patch(
                "qubesadmin.backup.dispvm.LOCKFILE", tmp.name
            ):
                obj.run()
    ...
    def test_101_run_pass_file(self):
        ...
        args = unittest.mock.Mock(
            backup_location="/backup/path", pass_file="/some/path", appvm=None
        )
        obj = RestoreInDisposableVM(self.app, args)
        methods = [
            "create_dispvm",
