...
class TC_10_QubesBase(qubesadmin.tests.QubesTestCase):
    ...
    def clone_setup_common_calls(self, src, dst):
        ...
        # tags
        self.app.expected_calls[(src, "admin.vm.tag.List", None, None)] = (
            b"0\0tag1\ntag2\n"
        )
        self.app.expected_calls[(dst, "admin.vm.tag.Set", "tag1", None)] = (
            b"0\0"
        )
        self.app.expected_calls[(dst, "admin.vm.tag.Set", "tag2", None)] = (
            b"0\0"
        )

        # features
        self.app.expected_calls[(src, "admin.vm.feature.List", None, None)] = (
            b"0\0feat1\nfeat2\n"
        )
        self.app.expected_calls[
        ...
        self.app.expected_calls[(dst, "admin.vm.firewall.Set", None, rules)] = (
            b"0\x00"
        )
    ...
    def test_050_automatic_reset_cache(self):
        ...
        self.assertAllCalled()
        self.app.actual_calls = []
        del self.app.expected_calls[("dom0", "admin.vm.List", None, None)]
        del self.app.expected_calls[
            ("vm1", "admin.vm.property.GetAll", None, None)
        ]
        self.app.expected_calls[
...
class TC_20_QubesLocal(unittest.TestCase):
    ...
    def test_000_qubesd_call(self):
        ...
        self.assertEqual(
            self.get_request(), b"some.method+arg1 dom0 name test-vm\0payload"
        )
    ...
    def test_001_qubesd_call_none_arg(self):
        ...
        self.assertEqual(
            self.get_request(), b"some.method+ dom0 name test-vm\0payload"
        )
    ...
    def test_002_qubesd_call_none_payload(self):
        ...
        self.assertEqual(
            self.get_request(), b"some.method+ dom0 name test-vm\0"
        )
    ...
    def _call_test_service_with_payload_stream(
        ...
        with mock.patch("qubesadmin.config.QREXEC_SERVICES_DIR", self.tmpdir):
