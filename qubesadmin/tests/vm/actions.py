...
class TC_00_Actions(qubesadmin.tests.vm.VMTestCase):
    ...
    def test_002_kill(self):
        self.app.expected_calls[("test-vm", "admin.vm.Kill", None, None)] = (
            b"0\x00"
        )
        self.vm.kill()
        self.assertAllCalled()
    ...
    def test_003_pause(self):
        self.app.expected_calls[("test-vm", "admin.vm.Pause", None, None)] = (
            b"0\x00"
        )
        self.vm.pause()
        self.assertAllCalled()
    ...
    def test_005_suspend(self):
        self.app.expected_calls[("test-vm", "admin.vm.Suspend", None, None)] = (
            b"0\x00"
        )
        self.vm.suspend()
        self.assertAllCalled()
    ...
    def test_006_resume(self):
        self.app.expected_calls[("test-vm", "admin.vm.Resume", None, None)] = (
            b"0\x00"
        )
        self.vm.resume()
        self.assertAllCalled()
