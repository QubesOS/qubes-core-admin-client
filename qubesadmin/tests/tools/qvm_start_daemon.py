...
from qubesadmin.tools.qvm_start_daemon import (
    validator_key_sequence,
    validator_trayicon_mode,
    validator_color,
)
...
class TC_00_qvm_start_gui(qubesadmin.tests.QubesTestCase):
    ...
    def setup_common_args(self):
        ...
        self.app.expected_calls[("dom0", "admin.label.Get", "red", None)] = (
            b"0\x000xff0000"
        )
        self.app.expected_calls[("dom0", "admin.label.Index", "red", None)] = (
            b"0\x001"
        )
        self.app.expected_calls[
            (
    ...
    def run_common_args(self):
        with (
            ...
            unittest.mock.patch.object(
                self.launcher, "write_guid_config"
...
""",
    ...
    def test_013_common_args_guid_config(self):
        ...
        self.app.expected_calls[
            ("test-vm", "admin.vm.feature.Get", "gui-allow-fullscreen", None)
        ] = b"0\x001"
...
""".splitlines()
        self.assertEqual(
            qubesadmin.tools.qvm_start_daemon.get_monitor_layout(),
